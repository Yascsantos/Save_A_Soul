...
-- Copiando dados para a tabela save.carrinho: ~10 rows (aproximadamente)
...
-- Copiando dados para a tabela save.descricao_ado: ~1 rows (aproximadamente)

-- Copiando dados para a tabela save.descricao_vol: ~2 rows (aproximadamente)
...
INSERT INTO `produto` (`id_pro`, `id_cat`, `prod`, `preco`, `qtd`, `modelo`, `outros`, `img_pro`) VALUES
	(1, 1, 'Vestido', 15.00, 30, 'Vestido rodado', 'Vestido para cachorrinhas de pequeno/m̩dio porte.', '../listagem/img/2023.08.01-23.18.19.jpg'),
	(2, 2, 'Pote para comida', 20.00, 10, 'Tigela dupla para comida', 'Capacidade: 250g', '../listagem/img/2023.08.01-23.20.31.jpg'),
	(3, 3, 'Botinha de chuva', 25.00, 40, 'Botinha de chuva para cachorrinhos', '---', '../listagem/img/2023.08.01-23.21.54.jpg');
